...
const UserProfile = () => {
  ...
  return (
    <>
      <SEO 
        title="My Profile"
        description="Manage your GDG PDEA blog profile, view your comments, and update your personal information. Connect with the GDG PDEA community through your personalized profile page."
        keywords="GDG PDEA profile, user dashboard, tech community profile, developer profile"
      />
